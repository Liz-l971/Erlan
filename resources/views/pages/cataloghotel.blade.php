            ...
            <div class="banner_content">
                ...
                <div class="mobile">
                    <form action="" class="banner_form">
                        ...
                        <input type="date" value="{{$search['date']}}" class="banner_inp_two" placeholder="период вылета">
                        <div class="flex">
                            <input type="text"  value="{{$search['nights']}}" class="banner_inp_three" placeholder="ночей">
                            <input type="text"  value="{{$search['tourists']}}" class="banner_inp_three" placeholder="чел">
                        </div>
        ...
        <section class="catalog_hotel">
            ...
            <form action="/filterHotel" class="left_catalog_hotel desktop" method="POST">
                ...
                <div class="filtr_block">
                    ...
                    <div class="filtr_block_column_price">
                        <input type="number" class="filtr_block_price_inp" name="cost_one" value="{{$filterHotel['cost_one']}}">
                        <hr class="price_line">
                        <input type="number" class="filtr_block_price_inp" name="cost_two" value="{{$filterHotel['cost_two']}}">
                    </div>
            ...
            <div class="right_catalog_hotel desktop">
                ...
                <div class="catalog_hotel_flex desktop">
                    <div class="catalog_info_hotel">
                        <img src="public{{$item->imageHotel()}}{{$item->img}}" class="img_hotel_catalog" alt="">
                ...
                {{-- <div class="catalog_hotel_flex desktop">
                    <div class="catalog_info_hotel">
                        <img src="../assets/img/hotel/KAFKA PLAZA.png" class="img_hotel_catalog" alt="">
                        <div class="text_info_hotel desktop">
                            <p class="name_hotel">
                                КАФКА ПЛАЗА
                            </p>
                        ...
                        <a href="/hotel" class="choice_hotel mobile">
                            выбрать
                        </a>
                    </div>
                    <hr class="catalog_hotel_line">
                    <div class="catalog_price_hotel desktop">
                        ...
                        <a href="/hotel" class="choice_hotel white_cur">
                            выбрать
                        </a>
                    </div>
                </div> --}}
