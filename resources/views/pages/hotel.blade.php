                        ...
                        <form action="" class="add_form">
                            ...
                            <div class="add_lab">
                                <label for="file_input" class="upload-button">
                                    ...
                                    <input type="file" accept="*" name="file" id="file_input">
                                </label>
                                <div class="add_st">
                                    <div class="add_star">
                                    <svg width="71" height="70" viewBox="0 0 71 70" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M35.653 44.8877L24.6863 51.5085L27.5738 39.0252L17.8905 30.6252L30.6655 29.546L35.653 17.7627L40.6405 29.546L53.4155 30.6252L43.7322 39.0252L46.6197 51.5085M64.8197 26.9502L43.8488 25.171L35.653 5.8335L27.4572 25.171L6.48633 26.9502L22.3822 40.746L17.628 61.2502L35.653 50.371L53.678 61.2502L48.8947 40.746L64.8197 26.9502Z" fill="white" />
                                      </svg>                                
                                </div>
                                <div class="add_star">
                                    <svg width="71" height="70" viewBox="0 0 71 70" fill="none" xmlns="http://www.w3.org/2000/svg">
